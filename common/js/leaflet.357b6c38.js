...
mymap.on("click",
    ...
    $(".ms-list-row1").click(function() {
        mymap.setView(new L.LatLng(50.060605, 20.018122), 10), L.marker([50.060605, 20.018122]).addTo(mymap).bindPopup("<b>Oddział Kraków</b><br /> ul. Sikorki 19<br> 31-581 Kraków").openPopup(),
